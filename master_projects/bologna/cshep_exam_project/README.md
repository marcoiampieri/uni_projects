### As a final examination project, we were tasked to write a program to graphically represent the Mandelbrot set, applying the concepts that were taught us in both the coding and cloud coumputing lectures 
